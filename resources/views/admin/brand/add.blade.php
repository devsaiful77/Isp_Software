            ...
            <form class="form-horizontal" id="registration" method="post" action="{{ (@$data)?route('brand.update') : route('brand.store') }}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="card-title card_top_title">{{ (@$data)?'Update':'New' }} Sub Category Information</h3>
                            </div>
                    ...
                    <div class="card-body card_form">
                        ...
                        <div class="form-group row custom_form_group{{ $errors->has('BranName') ? ' has-error' : '' }}">
                            <label class="col-sm-3 control-label">Device Sub Category:<span class="req_star">*</span></label>
                            <div class="col-sm-7">
                                <input type="text" placeholder="Device Sub Category Title" class="form-control" id="BranName" name="BranName" value="{{(@$data)?@$data->BranName:old('BranName')}}" required>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="card-title card_top_title"></i>Sub Category List</h3>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
