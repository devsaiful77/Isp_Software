    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="date__part">
                <p>  <strong class="td__red__color"> {{$reportTitle}} </strong> </p>
            </div>
            <!-- title -->
            ...
            <table>
                ...
                <tbody>
                    @php 
                        $totalAmount = 0;
                    @endphp
                    @foreach($customerList as $aRecord)
                        @php 
                            $totalAmount += $aRecord->price;
                        @endphp
                        <tr style="border:0; padding:0">
                            <td class="td__center">{{ $aRecord->customerName }}</td>
                            <td class="td__center">{{ $aRecord->email }}</td>
                            <td class="td__center">{{ $aRecord->phoneNo1 }}</td>
                            <td class="td__center">{{ $aRecord->serviceName }}</td>
                            <td class="td__center">{{ $aRecord->packageName }}</td>
                            <td class="td__center">{{ $aRecord->price }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
