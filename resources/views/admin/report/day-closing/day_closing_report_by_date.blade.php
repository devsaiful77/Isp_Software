                ...
                <td>
                    ...
                    <table width="1000" style="margin: 0px 0px 0px 50px;">
                        <tr>
                            ...
                            <th class="table-border">Account Head</th>
                        ...
                        <tr>
                            ...
                            <td class="table-border">Bill Collection</td>
                            <td class="table-border"> {{ $fromDate }} </td>
                            <td class="table-border"> {{ $toDate }} </td>
                            <td class="table-border">{{ $totalCustomerBillAmount }}</td>
                        </tr>
                        <tr>
                            <td colspan="4" style="font-size: 14px;padding-top: 10px;" align="right">Sub Total = {{ $totalCustomerBillAmount }}</td>
                        </tr>
                    </table>
                    <table width="100%" style="padding: 10px 5px 10px 5px;">
                        <tr>
                    ...
                    <table width="1000" style="margin: 0px 0px 0px 50px;">
                        ...
                        <tr>
                            <td class="table-border">1</td>
                            <td class="table-border">IIG Payment</td>
                            <td class="table-border"> {{ $fromDate }} </td>
                            <td class="table-border"> {{ $toDate }} </td>
                            <td class="table-border">{{ $totalIIGPayment }}</td>
                        </tr>
                        <tr>
                            <td colspan="4" style="font-size: 14px;padding-top: 10px;" align="right">Sub Total = {{ $totalIIGPayment }}</td>
                        </tr>
                    </table>
                    <table width="1000" style="margin: 30px 0px 0px 50px;">
                        <tr>
                            <td style="font-size: 14px;padding-top: 10px;" align="center">Net Profit = {{ $totalCustomerBillAmount - $totalIIGPayment }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
