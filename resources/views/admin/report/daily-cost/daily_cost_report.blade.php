...
<head>
    ...
    <title>Daily Cost Reports</title>
    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="date__part">
                <p> Daily Cost Date : <strong class="td__red__color"> {{ $date }} </strong> </p>
            </div>
            <!-- title -->
        ...
        <section class="table__part">
            <table>
                ...
                <tbody>
                    ...
                    @foreach($dailyCostRecords as $aRecord)

                        @php 
                            $totalAmount += $aRecord->amount;
                        @endphp
                        <tr style="border:0; padding:0">
                            <td class="td__center">{{ $aRecord->drTypeName }}</td>
                            <td class="td__center">{{ $aRecord->month_name }}</td>
                            <td class="td__center">{{ $aRecord->year }}</td>
