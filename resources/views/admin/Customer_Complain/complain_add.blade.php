            ...
            <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <label class="custom-control custom-radio">
                                        <input id="radio1" name="radio" type="radio" value="customer_name" class="custom-control-input">

                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description">Name</span>
                                    </label>
                                    <label class="custom-control custom-radio">
                                        <input id="radio2" name="radio" type="radio" value="phone_no" checked class="custom-control-input">
                                        <span class="custom-control-indicator"></span>
                ...
                <div class="mt-2">
                    <form action="{{ route('payment_insert_form') }}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-right">Mobile No </label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-right">Complain Details<span class="require_star">*</span> </label>
                            <div class="col-md-7">
                                <input type="text" name="complainDetails" class="form-control" value="{{ old('complainDetails') }}">
                                @error('complainDetails')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-right">Task Assign To<span class="require_star">*</span></label>
                            <div class="col-md-7">
                                <select class="form-control" name="assignToId">
